  ...
  return (
    ...
    >
      ...
      <div className="d-flex justify-content-around">
        ...
        <div className="d-flex align-items-center gap-2 create-hover-color rounded p-1 w-100 justify-content-center" data-bs-toggle="modal" data-bs-target="#createPostModal">
